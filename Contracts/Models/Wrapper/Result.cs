...
[ProtoContract]
[ProtoInclude(3, typeof(Result<int>))]
[ProtoInclude(4, typeof(PaginatedResult<GetAllPagedCustomersResponse>))]
public class Result
{
    [ProtoMember(1)] public List<string> Messages { get; set; } = new();
    [ProtoMember(2)] public bool Succeeded { get; set; }
